...
return [
    ...
    'text' => '<p>C’est ici que nous répondons aux questions fréquentes.<br />
Bien entendu cette section sera mise à jour très régulièrement.</p>
<p>Nous serions d’ailleurs heureux de répondre aux questions que vous vous poser et qui ne figurent pas ici.<br />
N’hésitez pas à nous envoyer un commentaire, une question ou une suggestion.<br />
Utilisez le formulaire de contact.</p>
',
    'title-1' => 'Tout le monde peut méditer ?',
    'title-2' => 'Que dois-je attendre de la pratique de la méditation ?',
    'title-3' => 'Comment apprendre à méditer ?',
    'title-4' => 'Devons- nous méditer quotidiennement ?',
    'title-5' => 'Combien de temps dois-je méditer ?',
    'title-6' => 'Oui mais, est-ce que je médite vraiment ?',
...
La méditation nous montre que la porte est ouverte en permanence et qu’à l’extérieur de la cage la vie est bien plus simple que l’esprit veut nous le faire croire.<br />
Cet esprit turbulent nous fait croire que si nous ne restons pas dans la cage, nous sommes en danger.<br />
Par une pratique régulière, notre expérience se transforme chaque jour un peu plus en réalité concrète et notre bonheur n\'est plus tributaire des conditions turbulentes du monde qui nous entoure. Cela a un impact bénéfique sur pratiquement tous les aspects de la vie quotidienne. </p>',
    'text-3' => '<p>Il n\'y a pas une bonne approche de la méditation qui convient à tout le monde. <br />
La meilleure approche est simplement celle qui fonctionne le mieux pour soi. <br />
Chez Turbulence Zéro certains ont commencé par se rapprocher de communautés Bouddhistes, d’autres ont beaucoup lu ou encore ont commencé par pratiqué la médiation comme un entrainement sportif avec la méditation guidée. <br />
De manière générale, le désir de trouver la sérénité suffit à nous pousser à « faire quelque chose ». En explorant le thème de la méditation nous trouvons notre propre voix.<br />
...
Au début il est important de méditer en sessions courtes et fréquentes. Une moyenne de 20 minutes par jour en une ou plusieurs sessions est une bonne ligne directrice.<br />
Aussi, il n’est pas recommandé de « seulement » méditer assis.<br />
En appliquant les deux principaux points de la posture, nous pouvons méditer n’importe où, n’importe quand. Au plus souvent nous prenons 1 ou 2 minutes dans la journée pour calmer notre esprit et être pleinement conscient de ce qui se passe dans le moment présent au plus nos progrès nous encourageront.</p>',
    'text-6' => '<p>La question en elle-même montre à quel point notre esprit travaille en permanence pour nous distraire. Méditer aide à accroitre notre conscient.<br />
En pratiquant il y a des moments où nous nous sentons perdus ou distraits par les pensées.<br />
C’est le but de la pratique de la méditation : ramenez l’esprit à un état de conscience.<br />
Pour ce faire il suffit de prendre de note de ce qui se passe et de ramener l’esprit sur l’objet de la session. Comme nous vous le proposons cela peut-être la respiration, les sensations physiques, les sons et ainsi de suite, mais surtout le « maintenant ».<br />
Le fait de se rendre compte que nous sommes distraits est en quelque sorte un signe que nous sommes conscients. Il suffit donc de laisser aller les distractions et de revenir à l’état méditatif, avec ou sans support particulier, de revenir à ce qui se passe dans le moment présent, rien d’autre.<br />
Et ceci est vrai pour nos sessions formelles comme pour le reste de la journée.<br />
Si nous marchons, portons notre attention sur ce fait. Pareil si nous mangeons, regardons un écran, lisons.</p>',
    'text-7' => '<p>Les pensées ne peuvent pas s’arrêter. Arrêter l’esprit de fonctionner est tout à fait impossible de même que nous ne pouvons pas arrêter nos poumons de respirer.<br />
Le piège lorsque l’on débute est de vouloir arrêter de penser. Au plus nous nous concentrons sur les pensées au plus nous leur donnons de l’importance et dès lors nous sommes incapables de calmer notre esprit.<br />
