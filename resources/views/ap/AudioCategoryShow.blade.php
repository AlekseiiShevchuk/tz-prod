...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form id="item_form"
                  action="{{ action('Ap\AudioCategoriesController@update', $item->id) }}"
                  method="post">
            ...
            {!! Form::open(['method' => 'DELETE', 'id' => 'delete_item_form', 'action' => ['Ap\AudioCategoriesController@destroy', $item->id]]) !!}
            {!! Form::close() !!}
        ...
        <div class="panel-footer">
            ...
            <a class="btn btn-link" href="{{ url(action('Ap\AudioCategoriesController@index')) }}">
                Cancel
            </a>
        </div>
    </div>
